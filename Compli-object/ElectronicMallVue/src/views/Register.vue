			...
			<div style="margin-top: 30px">
				<el-form label-width="70px">
					...
					<el-form-item style="text-align: center;">
						<el-button type="success" @click="onSubmit" style="font-size: 22px">
							<i class="iconfont icon-r-add" style="font-size: 22px"></i>注册
						</el-button>
						<el-button @click="$router.push('/login')" style="font-size: 22px">
							<i class="iconfont icon-r-left" style="font-size: 22px"></i> 返回登录
						</el-button>
					</el-form-item>
				</el-form>
			</div>
...
<style scoped>
	...
	#bk {
		...
		overflow-y: auto;
		height: 100%;
		background: url("../resource/img/register.jpg") center top / cover no-repeat;
	}
</style>
