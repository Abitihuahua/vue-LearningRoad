 ...
 * @Description:
 * @Author: mall
 * @Date: 2023-10-05 13:23:05
-->
<template>
    <div id="bk" class="wrapper">
        <div class="login-box">
            <div class="title">
                <b style="font-size: 28px"> "茶茗品" 欢迎您 </b>
            </div>
                ...
                <el-form label-width="70px">
                    ...
                    <el-form-item style="text-align: center">
                        <el-button
                            type="success"
                            @click="onSubmit"
                            style="font-size: 22px">登录</el-button>
                        <el-button
                            @click="$router.push('/register')"
                            style="font-size: 22px">注册</el-button>
...
#bk {
    ...
    overflow-y: auto;
    height: 100%;
    background: url("../resource/img/login.jpg") center top / 110% no-repeat;
}
